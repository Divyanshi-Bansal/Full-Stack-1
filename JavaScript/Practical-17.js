function digitalClock(){
    ...
    let mood = hour >=4 & hour <12 ? String.fromCodePoint(128519) : hour >=12 & hour <= 16 ? String.fromCodePoint(129300) : hour >= 17 & hour <= 18 ? String.fromCodePoint() : String.fromCodePoint() ;
